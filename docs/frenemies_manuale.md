...
**Appendice B. Partita d'esempio: cinque giorni per l'eclissi.** Una partita vera dall'inizio alla fine (in rifacimento).
...
> **In rifacimento.** Dopo i tanti cambi di regole recenti (fino alla v1.41) la partita d'esempio precedente è obsoleta e verrà riscritta da capo con un nuovo seed-vetrina. Il testo precedente, fermo alle vecchie regole, è archiviato in `docs/actual_play_sole_di_mezzanotte.md`.
