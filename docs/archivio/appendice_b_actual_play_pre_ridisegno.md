<!--
ARCHIVIO — Actual play "Il sole di mezzanotte" (Appendice B del manuale)
========================================================================

Cosa è. La copia integrale, narrata scena per scena, della partita d'esempio
dell'Appendice B (cinque scene, quattro mercati, finale, epilogo), estratta dal
manuale (docs/frenemies_manuale.md) al 1 luglio 2026.

Regole di riferimento. v1.31 (i punti sono valuta lineare; le figure entrano nel
mazzo e si rimescolano al mercato; il Jolly entra nel mazzo dei Protagonisti dopo
la seconda scena). Working tree sopra il commit a391df1, con il lavoro in corso
sull'Appendice B (partita canonica migrata al seed 29).

Perche' e' qui. E' conservata PRIMA del ridisegno delle regole che ne invalidera'
la giocata carta-per-carta:
  - v1.32 (prevista): il Jolly diventa una risorsa "swap disperato" fuori dal
    mazzo, disponibile nelle scene 1-4, che si afferra seppellendo una carta in
    fondo al mazzo; se non usato entro la 4a si perde.
  - v1.33 (prevista): le figure comprate al mercato non si rimescolano piu' nel
    mazzo ma entrano direttamente in mano ed escono in scena la volta successiva;
    l'asta accetta solo carte numeriche.
Entrambe cambiano le pescate, quindi il transcript e l'actual play andranno
rigenerati. L'actual play si rifara' con le regole nuove; questa versione resta
come CAVA riutilizzabile: personaggi, ambientazioni, tono e passaggi narrati
riusabili a prescindere dalle carte.

Vedi anche docs/fiction_esempio_scene1-2.md (fiction estesa scene 1-2, seed 23,
gia' conservata in-place come cava).
-->
