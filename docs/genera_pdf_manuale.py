...
.sg-foglio {{ page-break-inside: avoid; break-inside: avoid; }}
.sg-break {{ page-break-before: always; break-before: page; }}
.sg-titolo {{ font-family: 'Oswald','Arial Narrow',sans-serif; font-size: 15pt; color: {ORO};
        letter-spacing: 1px; text-transform: uppercase; margin: 4px 0 1px; }}
.sg-occh {{ font-style: italic; color: #8a7a48; font-size: 9.4pt; margin: 0 0 6px; }}
...
.sg-lab {{ display: block; font-family: 'Oswald','Arial Narrow',sans-serif; font-size: 8.6pt;
        letter-spacing: 1px; text-transform: uppercase; color: {GRIGIO}; margin: 4px 0 1px; }}
...
.sg-box {{ border: 1px solid {BORDO}; border-radius: 6px; background: #fff; padding: 4px 10px; margin-bottom: 4px; }}
.sg-righe .r {{ border-bottom: 1px solid #d9d3c4; height: 16px; }}
...
.sg-spinta {{ display: flex; gap: 10px; align-items: flex-start; padding: 2px 0; border-bottom: 1px dotted {BORDO}; }}
.sg-spinta:last-child {{ border-bottom: none; }}
.sg-spinta .q {{ flex: 1; }}
.sg-spinta .dom {{ font-weight: bold; font-size: 9.8pt; }}
.sg-spinta .scrivi {{ border-bottom: 1px solid #d9d3c4; height: 15px; margin-top: 3px; }}
...
.sg-qrow {{ width: 100%; padding: 6px 10px; margin-bottom: 7px; }}
